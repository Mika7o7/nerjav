...
function menuResponsive(){
	...
	if ($(window).width() < 992)
	{
		...
		$('.header_nav .right-nav .lang-curr-wrapper').appendTo('.nav2 .account .drop_account');
		$('.header_top .nav2 .header_wishlist').insertAfter('.header_top .nav2 .account .drop_account .compare');
	}else{
		$('#menu').css('display','block');
		...
		$('.header_top .nav2 .account .drop_account .lang-curr-wrapper').insertBefore('.header_nav .right-nav #header-nav-right');
		$('.header_top .nav2 .account .drop_account .header_wishlist').insertAfter('.header_top .nav2 .account');
...
function timecounter() {
	$('.countbox.hastime').each(function(){
		...
		$(this).countdown(countTime, function(event) {
			$(this).html(
				'<span class="timebox day"><span class="timebox-inner"><strong>'+event.strftime('%D')+'</strong><span class="time day">d</span></span></span><span class="timebox hour"><span class="timebox-inner"><strong>'+event.strftime('%H')+'</strong><span class="time hour">h</span></span></span><span class="timebox minute"><span class="timebox-inner"><strong>'+event.strftime('%M')+'</strong><span class="time min">m</span></span></span><span class="timebox second"><span class="timebox-inner"><strong>'+event.strftime('%S')+'</strong><span class="time sec">s</span></span></span>'
			);
		});
		// $(this).countdown('stop');
	});
